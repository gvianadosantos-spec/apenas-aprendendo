...
console.log('deseja usar um cumpum de desconto?');
console.log('insera 0 caso não deseja usar um cupom de desconto');
console.log('insera o valor do desconto caso deseja usar um cupom de desconto');
...
console.log('o total da sua compra deu R$' + total);
    ...
    let total2 = total -((total / 100) * desconto);
    console.log('o total da sua compra com o desconto deu R$' + total2);
}
